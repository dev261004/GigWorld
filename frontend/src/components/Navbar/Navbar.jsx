  ...
  return (
    <header className="sticky top-0 z-50 border-b border-white/60 bg-white/75 text-slate-700 shadow-[0_14px_34px_rgba(15,23,42,0.08)] backdrop-blur-xl">
      <div className="relative mx-auto flex max-w-7xl flex-col px-4 py-3 sm:px-6 lg:flex-row lg:items-center lg:px-8">
        ...
        <button
          type="button"
          className="absolute right-5 top-5 cursor-pointer rounded-lg p-1 text-slate-800 transition hover:bg-slate-100 focus:outline-none focus:ring-2 focus:ring-blue-600/20 lg:hidden"
        ...
        <nav
          ...
          className={`w-full flex-col items-center overflow-hidden transition-all duration-300 lg:ml-16 lg:flex lg:max-h-full lg:flex-row lg:overflow-visible lg:pt-0 ${
            isMobileMenuOpen ? "flex max-h-[38rem] pt-6" : "hidden max-h-0"
          }`}
        >
          <ul className="flex w-full flex-col items-center gap-2 text-sm font-semibold lg:flex-row lg:justify-center lg:gap-8">
            <li><Link className="rounded-lg px-3 py-2 text-slate-700 transition hover:bg-white hover:text-blue-700" to="/" onClick={closeNavigationMenus}>Home</Link></li>
            <li
            ...
            <li><Link className="rounded-lg px-3 py-2 text-slate-700 transition hover:bg-white hover:text-blue-700" to="/about" onClick={closeNavigationMenus}>About</Link></li>
            <li><Link className="rounded-lg px-3 py-2 text-slate-700 transition hover:bg-white hover:text-blue-700" to="/contact" onClick={closeNavigationMenus}>Contact</Link></li>
          </ul>
